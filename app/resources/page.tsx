...
// ─── Essential references (cross-cutting, not subject-specific) ───
const essentialReferences: Resource[] = [
  { title: "Visual Flight Rules Guide (VFRG) v8.3", description: "The essential reference for VFR operations — airspace, right of way, VMC minima, radio calls, and procedures. Allowed in RPL/PPL exams.", url: "https://www.casa.gov.au/resources-and-education/publications/industry-guides/pilot-guides-and-maps/visual-flight-rules-guide", source: "CASA" },
  { title: "Part 91 Plain English Guide v5.2", description: "Plain English explanation of the General Operating and Flight Rules — fuel requirements, flight planning, documentation, and operational rules.", url: "https://www.casa.gov.au/resources-and-education/publications/plain-english-guides/casr-part-91-plain-english-guide-general-operating-and-flight-rules#Whowillbenefit", source: "CASA" },
  ...
  { title: "AIP Australia", description: "The official Aeronautical Information Publication — ENR, AD, and GEN sections including airspace, procedures, and aerodrome data.", url: "https://www.airservicesaustralia.com/aip/aip.asp", source: "Airservices Australia" },
  { title: "ERSA — En Route Supplement Australia", description: "Aerodrome directory with runway data, frequencies, facilities, circuit directions, and operational information for every Australian aerodrome.", url: "https://www.airservicesaustralia.com/aip/aip.asp", source: "Airservices Australia" },
...
const resourcesBySubject: Record<string, { color: string; resources: Resource[] }> = {
  ...
  "Human Factors": {
    ...
    resources: [
      ...
      { title: "Pilot Safety Hub — Safety Resources", description: "Decision-making tools, checklists, close calls, safety posters, and webinar recordings for pilots.", url: "https://www.casa.gov.au/operations-safety-and-travel/aviation-safety-and-security-pilots/aviation-safety-resources-pilots", source: "CASA" },
    ],
  },
  "Aerodynamics": {
    color: "#00D4AA",
    resources: [
      { title: "ATSB Investigation Reports", description: "Aviation accident and incident reports — real-world case studies covering stalls, loss of control, and structural failures.", url: "https://www.atsb.gov.au/aviation-investigation-reports", source: "ATSB" },
      { title: "Flight Safety Australia", description: "CASA's aviation safety magazine with articles on aerodynamics, weather, human factors, and operational safety.", url: "https://www.flightsafetyaustralia.com/", source: "CASA / Flight Safety Australia" },
    ],
  },
  "Navigation": {
    color: "#8E6AC8",
    resources: [
      { title: "Pilot Safety Hub — Flight Planning", description: "Resources on flight planning including TAF interpretation, fuel planning, weight and balance, and pre-flight preparation.", url: "https://www.casa.gov.au/resources-and-education/pilot-safety-hub/flight-planning", source: "CASA" },
  ...
  "Performance": {
    color: "#48B0A2",
    resources: [
      { title: "Part 91 — Flight Rules and Performance", description: "Part 91 regulatory framework covering takeoff and landing minima, fuel requirements, and performance planning.", url: "https://www.casa.gov.au/rules/regulatory-framework/casr/part-91-casr-general-operating-and-flight-rules", source: "CASA" },
      { title: "BOM Aerodrome Climatologies", description: "Cloud, visibility, wind, and temperature statistics for over 250 aerodromes — useful for performance planning.", url: "https://www.bom.gov.au/aviation/climate/", source: "Bureau of Meteorology" },
    ],
  },
  "Systems": {
    color: "#D4A05A",
...
function ResourceLink({ r, color }: { r: Resource; color: string }) {
  return (
    ...
    >
      <div style={{ fontSize: 14, fontWeight: 500, color, marginBottom: 3 }}>
        {r.title}<span style={{ fontSize: 14, color: "#4A5568", marginLeft: 6 }}>↗</span>
      </div>
    ...
    <div className="quiz-root">
      ...
      <div className="quiz-container">
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 15, color: "#8899AA", margin: 0, lineHeight: 1.6 }}>Interactive tools, essential references, and curated study resources for Australian student pilots.</p>
        </div>
              ...
              <div key={tool.title} className="dash-card"
                ...
                <div className="dash-card-content">
                  <div className="dash-card-title">
                    {tool.title}
                    {!tool.available && <span style={{ fontSize: 11, color: "#4A5568", fontWeight: 400, marginLeft: 8, padding: "2px 8px", borderRadius: 100, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)" }}>Coming soon</span>}
                  </div>
        ...
        <div style={{ marginBottom: 32 }}>
          <div>
            <button
              ...
              style={{
                width: "100%", padding: "14px 18px", borderRadius: showEssentials ? "12px 12px 0 0" : 12,
                background: "#131F33", border: "1px solid rgba(255,255,255,0.06)",
                borderBottom: showEssentials ? "none" : "1px solid rgba(255,255,255,0.06)",
                cursor: "pointer", display: "flex", alignItems: "center", gap: 12,
                fontFamily: "'DM Sans', sans-serif", textAlign: "left",
              }}
            >
              <div style={{ width: 8, height: 8, borderRadius: 4, background: "#FFF", flexShrink: 0 }} />
              <span style={{ fontSize: 15, fontWeight: 600, color: "#FFF", flex: 1 }}>Essential references</span>
              <span style={{ fontSize: 12, color: "#4A5568", marginRight: 8 }}>VFRG, PEGs, AIP, ERSA, Workbook</span>
            ...
            {showEssentials && (
              <div style={{ background: "#131F33", border: "1px solid rgba(255,255,255,0.06)", borderTop: "none", borderRadius: "0 0 12px 12px", padding: "4px 0" }}>
                {essentialReferences.map((r, i) => <ResourceLink key={i} r={r} color="#FFF" />)}
              </div>
            )}
          </div>
        </div>
