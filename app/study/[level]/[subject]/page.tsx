      ...
      <div className="quiz-container">
        ...
        {!loading && !error && !quizComplete && q && (
          <>
            ...
            <p style={{ fontSize: 12, color: "#4A5568", lineHeight: 1.6, margin: 0 }}><a href="/terms" target="_blank" rel="noopener noreferrer" style={{ color: "#4A5568", textDecoration: "underline" }}>Terms</a>{" · "}<a href="/privacy" target="_blank" rel="noopener noreferrer" style={{ color: "#4A5568", textDecoration: "underline" }}>Privacy</a>{" · "}<span>vectored.com.au</span></p>
            </div>
          </>
        )}
      </div>
