      ...
      <div className="quiz-container">
        <div style={{ maxWidth: 640 }}>
          ...
          <div style={{ fontSize: 15, color: "#8899AA", lineHeight: 1.8 }}>
            ...
            <h2 style={{ fontSize: 18, color: "#FFF", fontWeight: 600, marginTop: 32, marginBottom: 12 }}>3. Use of the platform</h2>
            ...
            <h2 style={{ fontSize: 18, color: "#FFF", fontWeight: 600, marginTop: 32, marginBottom: 12 }}>4. Accounts and payments</h2>
            ...
            <h2 style={{ fontSize: 18, color: "#FFF", fontWeight: 600, marginTop: 32, marginBottom: 12 }}>5. Intellectual property</h2>
            ...
            <h2 style={{ fontSize: 18, color: "#FFF", fontWeight: 600, marginTop: 32, marginBottom: 12 }}>6. Career guidance disclaimer</h2>
            ...
            <h2 style={{ fontSize: 18, color: "#FFF", fontWeight: 600, marginTop: 32, marginBottom: 12 }}>7. Limitation of liability</h2>
            ...
            <h2 style={{ fontSize: 18, color: "#FFF", fontWeight: 600, marginTop: 32, marginBottom: 12 }}>8. Changes to these terms</h2>
            ...
            <h2 style={{ fontSize: 18, color: "#FFF", fontWeight: 600, marginTop: 32, marginBottom: 12 }}>9. Governing law</h2>
