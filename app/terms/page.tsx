      ...
      <div className="quiz-container">
        <div style={{ maxWidth: 640 }}>
          ...
          <div style={{ fontSize: 15, color: "#8899AA", lineHeight: 1.8 }}>
            ...
            <p style={{ marginTop: 12 }}>Certain diagrams used in question explanations are sourced from the <strong style={{ color: "#FFF" }}>FAA Pilot&apos;s Handbook of Aeronautical Knowledge (FAA-H-8083-25C)</strong>, which is a United States government publication in the public domain. These diagrams are used for educational illustration purposes only. Vectored is not affiliated with or endorsed by the Federal Aviation Administration (FAA). Australian student pilots should note that Australian regulations and procedures may differ from those described in FAA publications — always refer to CASA publications as the authoritative source for Australian aviation.</p>
